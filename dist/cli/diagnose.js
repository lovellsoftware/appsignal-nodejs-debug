...
class Diagnose {
    ...
    async run() {
        ...
        console.log(`    Path: ${format_value(data["paths"]["appsignal.cjs"]["path"])}`);
        this.print_newline();
    ...
    printConfiguration({ options, sources }, clientFilePath) {
        console.log(`Configuration`);
        if (Object.keys(sources.initial).length === 0) {
            console.log(`\x1b[31mWarning\x1b[0m: The initialiser file ('${clientFilePath}') could` +
...
_Diagnose_diagnose = new WeakMap();
